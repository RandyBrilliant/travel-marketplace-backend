    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_rating', models.DecimalField(decimal_places=2, default=0.0, help_text='Average rating out of 5.0.', max_digits=3, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(5.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified', models.BooleanField(default=False, help_text='Whether this review is from a verified booking.')),
                ('is_published', models.BooleanField(default=True, help_text='Whether to show this review publicly.')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('booking', models.ForeignKey(blank=True, help_text='Optional link to the booking this review is for.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='review', to='travel.booking')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['package', 'is_published'], name='travel_tour_package_c9c1c6_idx'),
        ),
    ]
