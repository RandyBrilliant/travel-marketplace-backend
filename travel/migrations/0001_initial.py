    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform_fee', models.DecimalField(decimal_places=2, default=50000.0, help_text='Platform fee in IDR (default: Rp. 50,000).', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Name of the reseller group.', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('commission_amount', models.DecimalField(decimal_places=2, help_text='Fixed commission amount for this reseller for this tour package.', max_digits=10)),
                ('currency', models.CharField(default='IDR', help_text="Currency code (e.g., 'IDR', 'USD').", max_length=10)),
